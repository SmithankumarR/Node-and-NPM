...
var arr = [2, 1, 3, 4, 5, 6, 7, 8, 9, 10];
var odd = ["a", "b", "c", "d"];
console.log(filter(arr, function (i) {
  return arr[i] % 2 == 0;
}));
console.log(map(arr, function (i) {
  return arr[i] % 2 !== 0;
}));
console.log(includes("a", 1));
console.log(chunk(odd, 2));
console.log(forEach(arr, function (i) {
  return console.log(arr[i]);
}));
},{"moment":"node_modules/moment/moment.js"}],"../../../.nvm/versions/node/v16.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.nvm/versions/node/v16.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
